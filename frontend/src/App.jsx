...
import { Settings, Check, Type, Globe } from 'lucide-react';
import './App.css';
  ...
  return (
    <div className="app-container">
      ...
      <main className="main-content" style={{ display: 'flex', flexDirection: 'column' }}>
        {activeWidget === 'chat' && <ChatAssistant language={language} />}
        {activeWidget === 'booth' && <FindBooth />}
        {activeWidget === 'timeline' && <Timeline />}
      </main>
    </div>
  );
}
